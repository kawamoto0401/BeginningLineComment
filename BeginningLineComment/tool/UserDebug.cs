...
namespace BeginningLineComment.tool {
    ...
    internal class OutputWriteLine : IWriteLine {
        ...
        public void ExceptionMessageBox(Exception exception, int line, string name, string path) {
            ...
            string str = string.Format("### Exception:{0},{1}\r\n{2},{3}\r\n{4}\r\n{5}", dt, dt.Millisecond, name, line, exception.Message, exception.StackTrace);
